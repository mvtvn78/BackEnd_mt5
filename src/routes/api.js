...
const {getFollowList,addFollow,removeFollow,searchFollow, getDetailFollowByCode, getTotalFollowByArtist} = require("../controllers/apiFollower")
...
const { getReleaseSong, addReleaseSong, removeReleaseSong,searchReleaseSong, getTotalSongsByArist } = require('../controllers/apiReleaseSong')
...
const initApiRoutes = (app) => {
    ...
    router.get('/followers_total_artist',getTotalFollowByArtist)
    //Fav API
    ...
    router.get("/release_total_artist",getTotalSongsByArist)
